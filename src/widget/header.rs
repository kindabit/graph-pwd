use iced::{widget::{button, row, text, toggler}, Alignment, Element, Length, Padding};
use log::warn;
...
impl Header {
  ...
  pub fn view(&self, i18n: &I18n, global_state: &GlobalState, style_variable: &StyleVariable) -> Element<Message> {
